...
public class JavaCommandFactoryImpl implements JavaCommandFactory {
  ...
  public boolean isEsEnabled() {
    return isCommandEnabled(ProcessProperties.CLUSTER_SEARCH_DISABLED);
  }

  @Override
  public boolean isCeEnabled() {
    return isCommandEnabled(ProcessProperties.CLUSTER_CE_DISABLED);
  }

  @Override
  public boolean isWebEnabled() {
    return isCommandEnabled(ProcessProperties.CLUSTER_WEB_DISABLED);
  }
  ...
  private boolean isCommandEnabled(String disabledPropertyKey) {
    return !settings.getProps().valueAsBoolean(ProcessProperties.CLUSTER_ENABLED) ||
      !settings.getProps().valueAsBoolean(disabledPropertyKey);
  }
